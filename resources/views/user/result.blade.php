		...
		<div class="col-md-10 col-md-offset-1">
			<div class="panel panel-default">
				...
				<div class="panel-footer" align="center">
					...
					{{ Form::button('Print PDF&nbsp;<i class="icon-doc"></i>',['type' => 'button', 'class' => 'btn btn-primary', 'id' => 'print_pdf'])  }}
				</div>                     	
			</div>
		</div>
	</div>
</div>          
{{ Form::hidden('id', $detail->id, array('id' => 'id')) }}
...
$(document).ready(function(){
	...
	$(document).on('click','#print_pdf',function() {
		var answer = confirm('Do you want to download the pdf?');
		if (answer == true) {


            $.ajax({
                url: $('#base_url').val() + '/download/pdf',
                type: 'POST',
                data: {_token: $('#token').val(), id: $('#id').val()},
